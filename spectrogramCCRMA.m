...
%   02/23/10/aak:
%   The original code for this function was downloaded from the following
%   website & then modified to suit my needs.
%   https://ccrma.stanford.edu/~jos/sasp/Matlab_Computing_Spectrograms.html
%   #sec:spectrogramml
